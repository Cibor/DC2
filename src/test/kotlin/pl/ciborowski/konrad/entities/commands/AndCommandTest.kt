...
class AndCommandTest : CommandTest() {

    @Test
    fun test_immediate_address_mode() {
        computer.accumulator = -3
        val operand = Operand(IMMEDIATE, 7)
        computer.invokeCommand(AndCommand(), operand)
        assertEquals(-3 and 7, computer.accumulator)
    ...
    fun test_direct_address_mode() {
        ...
        computer.invokeCommand(AndCommand(), operand)
        assertEquals(11 and -11, computer.accumulator)
    ...
    fun test_indirect_address_mode() {
        ...
        computer.invokeCommand(AndCommand(), operand)
        assertEquals(33 and 9, computer.accumulator)
    ...
    fun test_offset_address_mode() {
        ...
        computer.invokeCommand(AndCommand(), operand)
        assertEquals(3 and 5, computer.accumulator)
