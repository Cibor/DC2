...
class ShrCommandTest : CommandTest() {

    @Test
    fun test_immediate_address_mode() {
        computer.accumulator = -3
        val operand = Operand(IMMEDIATE, 7)
        computer.invokeCommand(ShrCommand(), operand)
        assertEquals(-3 shr 7, computer.accumulator)
    ...
    fun test_direct_address_mode() {
        ...
        computer.invokeCommand(ShrCommand(), operand)
        assertEquals(11 shr -11, computer.accumulator)
    ...
    fun test_indirect_address_mode() {
        ...
        computer.invokeCommand(ShrCommand(), operand)
        assertEquals(33 shr 9, computer.accumulator)
    ...
    fun test_offset_address_mode() {
        ...
        computer.invokeCommand(ShrCommand(), operand)
        assertEquals(3 shr 5, computer.accumulator)
