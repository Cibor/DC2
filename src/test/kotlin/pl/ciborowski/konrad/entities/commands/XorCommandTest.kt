...
class XorCommandTest : CommandTest() {

    @Test
    fun test_immediate_address_mode() {
        computer.accumulator = -3
        val operand = Operand(IMMEDIATE, 7)
        computer.invokeCommand(XorCommand(), operand)
        assertEquals(-3 xor 7, computer.accumulator)
    ...
    fun test_direct_address_mode() {
        ...
        computer.invokeCommand(XorCommand(), operand)
        assertEquals(11 xor -11, computer.accumulator)
    ...
    fun test_indirect_address_mode() {
        ...
        computer.invokeCommand(XorCommand(), operand)
        assertEquals(33 xor 9, computer.accumulator)
    ...
    fun test_offset_address_mode() {
        ...
        computer.invokeCommand(XorCommand(), operand)
        assertEquals(3 xor 5, computer.accumulator)
